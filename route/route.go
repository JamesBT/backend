...
func Init() *echo.Echo {
	...
	e.PUT("/user/id/nofoto", controler.UpdateUserByIdTanpaFoto)
	...
	e.GET("/asset/others", controler.GetAllAssetOthers)
	e.GET("/asset/ditawarkan", controler.GetAllAssetDitawarkan)
	...
	e.POST("/asset/filter/sewa", controler.FilterAssetSewa)
	e.GET("/asset/detail/:id", controler.GetAssetDetailedById)
	e.GET("/asset/detail/allgambar/:id", controler.GetAssetDetailedByIdAllGambar)
	...
	e.GET("/survey_req/detail/custom", controler.CustomGetAllSurveyReqDetailed)
	...
	e.GET("/survey_req/notverif/:id", controler.GetAllNotVerifiedSurveyReqByUserId)
	e.GET("/survey_req/submitted/:id", controler.GetAllSubmittedSurveyReqByUserId)
	...
	e.PUT("/notification/:id/:is_read", controler.UbahIsReadNotifById)
	e.PUT("/notification/user/:user_id", controler.UbahIsReadNotifByUserId)
